            ...
            <div class="col-md-4 ">
               <div class="home-right right-one" style="padding-top: 150px;">
                    <div class="right-one">
                          ...
                          <div class="row" >
                             <div class="col-md-6 rg-bttn " style="width: 30%">  <div class="button btn-one"><a href="blood-doner-list">All Doner </a></div></div>
                             <div class="col-md-6 rg-bttn "  style="width: 40%"><div class="button" ><a href="blood-registrasion"> Register  </a></div></div>
                          </div>
                        ...
                        <div class="tab-content tabs">
                           ...
                           <div role="tabpanel" class="tab-pane fade in active" id="abSection1">
                              <div class="ih-item square effect9 bottom_to_top">
                                 <a>
                                    <div class="img"> <img src="images/profile.jpg" width="200" height="200" ></div>
                                    <div class="info">
                                       <div class="info-back">
                              ...
                              <div class="center">
                                 <div id="social-test">
                                    <ul class="social">
                                       <li><a href="https://www.facebook.com/rupom.hasan.77" title=""><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-6 cv-part">
                                 <p>Download my cv</p>
                                   <div class="downArrow bounce">
                                      <img width="40" height="40" alt="" src=" images/download-arrow.png"/>
                                    </div>
                              </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="gl-Section1">
                           <div class="row">
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/wordpress/wp2.png"><img src="images/portfolio/wordpress/wp2.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                     <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/wordpress/wp1.jpg">    <img src="images/portfolio/wordpress/wp1.1.jpg" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                   <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/landing1.png">    <img src="images/portfolio/landing1.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/design/tem4.png">    <img src="images/portfolio/design/tem4.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                                      <a href="#" class="link">
                                       <span data-hover="click here">project link</span>
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/design/tem5.png">    <img src="images/portfolio/design/tem5.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/design/tem6.png">    <img src="images/portfolio/design/tem6.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="gl-Section2">
                           <div class="row">
                              <div class="col-md-4 col-sm-4  col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/webdev/dev1.png">    <img src="images/portfolio/webdev/dev1.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                                     <a href="#" class="link">
                                       <span data-hover="click here">project link</span>
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images/portfolio/webdev/dev2.png">    <img src="images/portfolio/webdev/dev2.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                                       <a href="#" class="link">
                                       <span data-hover="click here">project link</span>
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                 <div class="pricing-box clrbg-before clrbg-after transition" style="padding:10px 0px;">
                                    <div class="item">
                                       <a class="venobox" data-gall="myGallery" href="images//portfolio/webdev/dev3.png">    <img src="images/portfolio/webdev/dev3.1.png" height="300" style="width: 100%" alt=""/>
                                       </a>
                                    </div>
                                      <a href="#" class="link">
                                       <span data-hover="click here">project link</span>
              ...
              <div class="section-title">
               <div class="btn btn-lg">
                 ...
                 spl_autoload_register(function($class){
                     ...
                     $user= new user();
                     foreach ($user->readAll('blog_table') as  $value) {
                     ?>
                              ...
                              <div class="serviceBox">
                                  ...
                                  <div class="blog-bottom">
                                    <div class="left col-md-6 col-sm-6">
                                          <button type="btn">
                                             <?php echo "<a href='blog.php?action=view&id=".$value['blog_id']."'>read more....</a>"; ?>
                                          </button>
                    ...
                    spl_autoload_register(function($class){
                        ...
                        $user= new user();
                            ...
                            if (isset($_POST ['submit'])) {
                                ...
                                if ($user->insert()) {
                                    echo "<span class='scs-msg'style='color:green;font-size:20px;margin-left:10%;text-transform:uppercase;'>your massage successfully send </span>";
                                }
               ...
               <div class="wrap-contact100">
                  ...
                  <form class="contact100-form validate-form" action="#contact" method="post">
                     ...
                     <div class="wrap-input100 mt-20">
                        <input id="phone" class="input100" type="text" name="phone" placeholder="Enter your phone">
                        <span class="focus-input100"></span>
                     </div>
